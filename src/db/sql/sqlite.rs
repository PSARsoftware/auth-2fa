...
// /// this repo compiles : cargo rustc -- --cfg sqlite
// // pub struct SqliteRepo<DB: sqlx::database::Database> {
// pub struct SqliteRepo {
//     pool: Pool<Sqlite>,
// }
//
// //#[cfg(all(sqlite))]
// impl Repo<Sqlite> for SqliteRepo {
//
...
//                 created_at as "created_at", updated_at as "updated_at" FROM auth_users WHERE $1 = $2"#,
//                 field_name,
//                 field,
//             )
